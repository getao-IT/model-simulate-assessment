 ...
 */
@Service(value = "MFHFX-DATASERVICE")
public class DataFHFXServiceImpl extends ServiceImpl<SimulateDataDao, SimulateDataInfo> implements SimulateDataService<SimulateDataInfo> {
